...
public class ItensDaListaDAO {
    ...
    public ItensDaListaDAO(Conexao conexao) {
        this.conexao = conexao;
    }

    // Lista itens de uma lista, com dados do produto.
    public List<ItensDaLista> findByLista(Integer lcCod) {
        String sql =
    ...
    public boolean save(ItensDaLista item) {
        String sqlVer =
    ...
    public boolean deleteItem(Integer lcCod, Integer prodCod) {
        String sql =
    ...
    public boolean deleteByLista(Integer lcCod) {
        String sql =
                "delete from itens_da_lista " +
                        " where lista_compra_lc_cod = ?";
