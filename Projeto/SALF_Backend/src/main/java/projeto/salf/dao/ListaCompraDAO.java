...
public class ListaCompraDAO {
    ...
    public List<ListaCompra> searchByDescricao(String termo) {
        String like = "%" + termo + "%";
        String sql =
                "select lc.lc_cod, lc.funcionario_func_cpf, lc.data_criacao, " +
                        "       lc.descricao, lc.status_atendimento, f.func_nome " +
    ...
    public List<ListaCompra> searchByCpf(String termo) {
        String like = "%" + termo + "%";
        String sql =
                "select lc.lc_cod, lc.funcionario_func_cpf, lc.data_criacao, " +
                        "       lc.descricao, lc.status_atendimento, f.func_nome " +
    ...
    public List<ListaCompra> searchByNomeFuncionario(String termo) {
        String like = "%" + termo + "%";
        String sql =
                "select lc.lc_cod, lc.funcionario_func_cpf, lc.data_criacao, " +
                        "       lc.descricao, lc.status_atendimento, f.func_nome " +
